  ...
  <main class="auth-page px-4 py-12">
    ...
    <div class="w-full max-w-md">
      <div class="auth-card">
        ...
        <p class="mt-2 text-sm text-gray-600">Start your personalized career journey</p>

        <form class="mt-6 space-y-4" @submit.prevent="doRegister">
          <div>
            <label class="label">Full name</label>
            <div class="input-group mt-1">
              <svg class="input-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.5 20.118a7.5 7.5 0 0115 0V21A2.25 2.25 0 0117.25 23.25H6.75A2.25 2.25 0 014.5 21v-.882z" />
              </svg>
              <input v-model="fullName" type="text" autocomplete="name" class="input input-lg with-icon-left" />
            </div>
          </div>
          <div>
          ...
          <div>
            ...
            <div class="input-group mt-1">
              ...
              <input v-model="password" :type="showPassword ? 'text' : 'password'" required autocomplete="new-password" :class="['input','input-lg','with-icon-left','with-icon-right', { 'input-error': passwordError }]" />
        ...
        <button @click="registerWithGoogle" :disabled="loading" class="btn btn-outline btn-lg w-full mt-3 disabled:opacity-60">
